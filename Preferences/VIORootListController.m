...
- (void)viewDidLoad {
    ...
    self.appearanceSettings = [self appearanceSettings];
    ...
    [[self iconView] setImage:[UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/VioletPreferences.bundle/icon.png"]];
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/VioletPreferences.bundle/Banner.png"]];
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:@"/var/jb/Library/MobileSubstrate/DynamicLibraries/Violet.disabled"]) {
